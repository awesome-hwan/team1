    ...
    <form id="join" method="post">
     ...
     <label for="sb-nickname">닉네임</label>
      ...
      <label for="sb-password">비밀번호</label>
        <input type="password" id="sb-password" placeholder="비밀번호" required>
         <label for="sb-Password-conf">비밀번호 확인</label>
           <input type="password" id="sb-password-conf" placeholder="비밀번호확인" @keyup.enter="clickedSignUpButton" required>
